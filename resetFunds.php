<?php
   ...
   if(!isset($_SESSION['user_id'])){
      ...
      $create_new_categories_record = $connection->prepare("INSERT INTO categories (grocery, education, transportation, utilities, apartment_rent, clothing, recreation, vacation, savings, medical, house_help, hospitality, charitable, tithe, time_stamp) VALUES (400, 400, 400, 400, 400, 400, 400, 400, 400, 400, 400, 400, 400, 400, :current_date)");
