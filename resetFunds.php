<?php
   ...
   if(!isset($_SESSION['user_id'])){
      ...
      $create_new_categories_record = $connection->prepare("INSERT INTO categories (grocery, education, transportation, utilities, apartment_rent, clothing, recreation, vacation, savings, medical, house_help, hospitality, charitable, tithe, time_stamp) VALUES (3588, 4058, 2018, 1256, 4750, 897, 1794, 1794, 2243, 448, 800, 717, 448, 2691, :current_date)");
